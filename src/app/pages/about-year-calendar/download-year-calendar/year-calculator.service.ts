...
export class YearCalculatorService {
  ...
  personalYearMeanings: {
    [key: number]: {
      ...
      1: {
        name: "Новий старт",
        advice: "Плануй нові починання, будь відкритим до змін.",
        explanation: "Рік 1 символізує початок нового циклу, оновлення і запуск нових проектів.",
        example: "Можеш розпочати нову роботу або навчання, змінити сферу діяльності."
      },
      2: {
        name: "Внутрішній баланс",
        advice: "Приділяй увагу відносинам та гармонії всередині себе.",
        explanation: "Рік 2 фокусується на співпраці, терпінні та взаєморозумінні.",
        example: "Спільні проєкти, зміцнення партнерств, розвиток особистих стосунків."
      },
      3: {
        name: "Розвиток і творчість",
        advice: "Використовуй креативність та комунікаційні навички для росту.",
        explanation: "Рік 3 приносить активність, навчання і прояв талантів.",
        example: "Заняття творчістю, виступи, презентації і нові соціальні контакти."
      },
      4: {
        name: "Стабільність і організація",
        advice: "Сконцентруйся на плануванні та дисципліні.",
        explanation: "Рік 4 допомагає закріпити фундамент, обрати порядок і системність у справах.",
        example: "Будівництво кар’єри, створення системи в бізнесі або особистому житті."
      },
      5: {
        name: "Зміни і пригоди",
        advice: "Будь гнучким, приймай зміни і нові можливості.",
        explanation: "Рік 5 символізує рух, подорожі, адаптацію та неочікувані події.",
        example: "Можливі поїздки, зміни місця роботи, нові знайомства."
      },
      6: {
        name: "Відповідальність і сім’я",
        advice: "Приділяй увагу близьким і домашнім справам.",
        explanation: "Рік 6 приносить турботу, стабільність у родині та особистих стосунках.",
        example: "Допомога родині, важливі рішення щодо дому чи виховання дітей."
      },
      7: {
        name: "Рефлексія і розвиток внутрішнього світу",
        advice: "Займайся саморозвитком і аналізом власних дій.",
        explanation: "Рік 7 стимулює глибокий внутрішній аналіз, навчання та духовне зростання.",
        example: "Медитація, навчання, самопізнання та внутрішні пошуки."
      },
      8: {
        name: "Матеріальний успіх і кар’єра",
        advice: "Активно працюй над досягненням фінансових і професійних цілей.",
        explanation: "Рік 8 фокусується на досягненнях, управлінні ресурсами та реалізації планів.",
        example: "Кар’єрне зростання, бізнес-проєкти, фінансові інвестиції."
      },
      9: {
        name: "Завершення і підсумки",
        advice: "Підводь підсумки, відпускай старе і готуйся до нового циклу.",
        explanation: "Рік 9 символізує завершення циклу, очищення і підготовку до нового етапу.",
        example: "Завершення старих проєктів, підбиття підсумків особистих чи професійних справ."
      }
    };
  ...
  consciousMeanings: {
    [key: number]: { name: string, explanation: string, advice: string, example: string }
      ...
      1: {
        ...
        example: "керівник, новатор, підприємець."
      },
      2: {
        ...
        example: "дипломат, сімейний радник."
      },
      3: {
        ...
        example: "актор, письменник, маркетолог."
      },
      4: {
        ...
        example: "будівельник, інженер, бухгалтер."
      },
      5: {
        ...
        example: "мандрівник, блогер, журналіст."
      },
      6: {
        ...
        example: "вчитель, психолог, дизайнер інтер’єрів."
      },
      7: {
        ...
        example: "дослідник, науковець, філософ."
      },
      8: {
        name: "Амбіції, успіх",
      ...
      9: {
        ...
        example: "лікар, волонтер, наставник."
      }
    };
  ...
  missionMeanings: {
    [key: number]: { name: string, explanation: string, advice: string, example: string }
      ...
      1: {
        ...
        example: "керівник проєкту, організатор заходів."
      },
      2: {
        ...
        example: "дипломат, сімейний радник, переговорник."
      },
      3: {
        ...
        example: "письменник, актор, маркетолог."
      },
      4: {
        ...
        example: "бухгалтер, інженер, менеджер."
      },
      5: {
        ...
        example: "мандрівник, журналіст, блогер."
      },
      6: {
      ...
      7: {
        ...
        example: "науковець, філософ, дослідник."
      },
      8: {
      ...
      9: {
        ...
        example: "лікар, наставник, волонтер."
      }
    };
